...
import { Plus, Edit2, Trash2, Save, X, Database, AlertCircle, CheckCircle } from 'lucide-react';
...
const DataManagement = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const endpoint = editingId 
            ? `http://localhost:3000/api/user-data/${editingId}`
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-gray-400 mt-2">Add, edit, or delete your custom yield data</p>
                </div>
            ...
            {/* Add/Edit Form */}
            {showForm && (
                <div className="bg-slate-800/80 border border-white/10 rounded-xl p-6 mb-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="grid md:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-sm font-medium text-gray-300 mb-2">Species Name</label>
                                <input
                                    type="text"
                                    value={formData.species}
                                    onChange={(e) => setFormData({...formData, species: e.target.value})}
                                    className="w-full bg-slate-700 border border-slate-600 rounded-lg p-3 text-white focus:ring-2 focus:ring-cyan-500 outline-none"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-300 mb-2">Product/Conversion</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-300 mb-2">Yield (%)</label>
                                <input
                                    type="number"
                                    step="0.1"
                                    min="0"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-300 mb-2">Source/Notes</label>
                                <input
                                    type="text"
            ...
            <div className="bg-slate-800/80 border border-white/10 rounded-xl overflow-hidden">
                <div className="p-4 border-b border-white/10">
                    <h2 className="text-lg font-semibold text-white">Your Custom Data</h2>
                </div>
                            ...
                            <div key={item.id} className="p-4 flex items-center justify-between hover:bg-white/5 transition">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-400">
                                        ...
                                        {item.source && <span className="ml-2 text-gray-500">({item.source})</span>}
                                    </p>
                                </div>
