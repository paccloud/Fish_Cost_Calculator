    ...
    return (
        <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="relative mb-12 group">
                ...
                <div className="relative bg-slate-800/80 backdrop-blur-sm border border-white/10 rounded-2xl p-8 md:p-10">
                    <div className="flex items-center gap-3 mb-6">
                        <Anchor className="h-6 w-6 text-cyan-400" />
                        <h2 className="text-2xl font-semibold text-white">The Origin Story</h2>
                    </div>
                    ...
                    {/* Catch Network Link */}
                    <div className="mt-8 p-4 bg-slate-700/50 rounded-xl border border-white/5">
                        <div className="flex items-start gap-4">
                            <div className="bg-gradient-to-br from-blue-500 to-cyan-500 p-2 rounded-lg shrink-0">
                                <ExternalLink className="h-5 w-5 text-white" />
                            </div>
                            <div>
                                <h3 className="font-medium text-white mb-1">Learn About Catch</h3>
            ...
            <div className="relative mb-12 group">
                ...
                <div className="relative bg-slate-800/80 backdrop-blur-sm border border-white/10 rounded-2xl p-8 md:p-10">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h2 className="text-2xl font-semibold text-white">Open Source & Free Forever</h2>
                    </div>
            ...
            <div className="relative group">
                ...
                <div className="relative bg-slate-800/80 backdrop-blur-sm border border-white/10 rounded-2xl p-8 md:p-10 text-center">
                    <div className="inline-flex items-center justify-center mb-6">
                    ...
                    <h2 className="text-2xl font-semibold text-white mb-4">Support Future Updates</h2>
